...
function Products() {
  ...
  // };
  return (
    <div className="md:-mt-28 mt-0 bg-blue-200 text-white">
      <div className="z-30 relative items-center justify-center w-full h-full overflow-auto">
        ...
        ></div>
        <div className="absolute inset-0 z-20 flex items-center justify-center h-screen w-full bg-black bg-opacity-60"></div>
      ...
      <div>
        <div className="flex flex-wrap justify-center md:pt-16 pt-4">
          <div className="md:w-1/3 w-full my-6">
            <div className="flex flex-col justify-center items-center align-middle bg-blue-100 rounded-lg lg:mx-24 md:mx-12 mx-24">
              <div>
                <img
      ...
      <section className="mt-20 lg:mt-16">
        <div className="ld:w-2/5 flex lg:justify-center text-black text-4xl mt-10 font-bold pl-6">
          Our Softwares
        </div>
